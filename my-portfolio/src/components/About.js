    ...
    return (
        <div className='container'>
            <div style={{ whiteSpace: 'pre-wrap' }}>
                ...
                {"\n\n"}
                <p>
                I am a Back End Developer who recently earned a certificate in Full Stack Development from Case Western University, where I developed skills in Node.js, React.js, MongoDB and more.
                {"\n\n"}
